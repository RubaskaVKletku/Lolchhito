<?php
  ...
  $key = $_REQUEST['code'];
	...
	$redirect_uri = "https://github.com/RubaskaVKletku/Lolchhito/blob/master"; //In this example the redirect_uri is just pointing back to this file
	...
	$uri = file_get_contents("https://api.foursquare.com/v2/users/self?oauth_token=".$obj->access_token, true); 
